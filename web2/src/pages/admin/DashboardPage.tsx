...
import { DashboardSummary, WeeklyAppointment, WeeklyPatient } from '@/types';
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <ul className="space-y-2">
                        {(summary?.weekly_appointments ?? []).map((cita: WeeklyAppointment) => (
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <ul className="space-y-2">
                        {(summary?.weekly_patients ?? []).map((paciente: WeeklyPatient) => (
