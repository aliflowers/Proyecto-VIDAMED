                    ...
                    <div className="space-y-8">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start">
                                    ...
                                    <div className="ml-4">
                                        ...
                                        <p className="text-gray-600">Av. Principal, Nro 123, Ciudad Capital</p>
                                    </div>
                                </div>
                                <div className="flex items-start">
                        ...
                        <div>
                           <div className="aspect-w-16 aspect-h-9 rounded-lg overflow-hidden">
                                <iframe
                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3923.017551381987!2d-66.9059736852015!3d10.499878992514332!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8c2a58ad84385c7b%3A0x8a5c37862f79615a!2sPlaza%20Bol%C3%ADvar%20de%20Caracas!5e0!3m2!1sen!2sve!4v1657812198123!5m2!1sen!2sve"
                                    width="100%"
                                    height="100%"
                                    style={{ border: 0 }}
