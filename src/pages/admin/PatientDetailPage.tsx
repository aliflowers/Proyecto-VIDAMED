...
import { Loader, ArrowLeft, User, Mail, Phone, Fingerprint, Home, Eye, Trash2, BrainCircuit } from 'lucide-react';
import { PatientDetails, SchedulingStudy, Cita, ResultadoPaciente, ResultadoEliminado } from '@/types';
...
const PatientDetailPage: React.FC = () => {
    ...
    const handleDeleteResult = async (resultId: number) => {
        if (window.confirm('¿Estás seguro de que quieres eliminar este resultado? Esta acción no se puede deshacer.')) {
            ...
            if (!resultToDelete || !resultToDelete.resultado_data) return;
    ...
    const handleGenerateInterpretation = async (result: ResultadoPaciente) => {
        ...
        <div>
            ...
            <div className="mt-8">
                ...
                <div className="bg-white p-8 rounded-lg shadow-md">
                    ...
                    <ul>
                        {patient.resultados_pacientes.map((res: ResultadoPaciente) => (
