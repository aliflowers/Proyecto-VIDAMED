...
const StudiesPage: React.FC = () => {
    ...
    useEffect(() => {
        const fetchStudies = async () => {
            ...
            if (error) {
                ...
                const formattedData: Study[] = data.map((item) => ({
                    id: item.id.toString(),
                    name: item.nombre,
    ...
    const filteredStudies = useMemo(() => {
        return studies.filter(study => {
            ...
            const matchesSearch = study.name.toLowerCase().includes(searchTerm.toLowerCase()) || (study.description && study.description.toLowerCase().includes(searchTerm.toLowerCase()));
