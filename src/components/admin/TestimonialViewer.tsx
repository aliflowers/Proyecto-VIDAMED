...
const TestimonialViewer: React.FC<TestimonialViewerProps> = ({ testimonial, onClose }) => {
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl flex flex-col max-h-[85vh] overflow-y-auto">
                ...
                <div className="p-4 sm:p-8">
                    ...
                    <p className="text-gray-700 italic mb-4 break-words">"{testimonial.texto}"</p>
