...
const ChatInterface: React.FC = () => {
    ...
    const { messages, isLoading, sendMessage, isChatEnabled } = useChat();
            ...
            <form onSubmit={handleSendMessage} className="p-4 border-t border-gray-200 bg-white rounded-b-lg">
                <div className="relative">
                    <input
                        ...
                        placeholder={isChatEnabled ? "Escribe tu pregunta..." : "Chat deshabilitado"}
                    ...
                    />
                    <button type="submit" className="absolute right-2 top-1/2 -translate-y-1/2 bg-primary text-white p-2 rounded-full hover:bg-primary-dark disabled:bg-gray-400" disabled={isLoading || !isChatEnabled}>
                        <Send size={18} />
                    </button>
                </div>
            </form>
